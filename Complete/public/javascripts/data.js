...
function makeGraphApiCall(accessToken, searchTerm) {
    console.log('makeGraphApiCall', searchTerm);

    $.ajax({ type: 'GET', url: `/getuserdata/${searchTerm}`, headers: { access_token: accessToken }, cache: false })
